class AudioController {
    constructor() {
        // PERBAIKAN: Ganti 'ht://rw' dengan 'https://raw'
        ...
        // PERBAIKAN: Gunakan URL lengkap untuk gameOverSound
        ...
        this.hoverSound = new Audio('https://raw.githubusercontent.com/WebDevSimplified/Mix-Or-Match/master/Assets/Audio/ghost.wav');
    ...
    // TAMBAHKAN: Method baru untuk efek hover tombol
    playHover() {
...
// CLASS MixOrMatch TETAP SAMA DENGAN MILIK ANDA (tidak diubah)
class MixOrMatch {
...
function ready() {
    ...
    // TAMBAHKAN: Efek suara untuk tombol back to lobby
    const backBtn = document.querySelector('.back-to-lobby-btn');
    if (backBtn) {
        backBtn.addEventListener('mouseenter', () => {
            if (game && game.audioController) {
                game.audioController.playHover();
            }
        });
    }
